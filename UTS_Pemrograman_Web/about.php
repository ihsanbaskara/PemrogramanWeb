...
<div class="section-container content-container">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="col-md-6">
                    <img src="<?php echo $ambil_data[0]["url_gambar"]; ?>" class="img-responsive" alt=""> 
                </div>
                <div class="col-md-6">
                    <h1 class="h2"><?php echo $ambil_data[0]["nama"]; ?></h1>
                    <p><?php echo $ambil_data[0]["penjelasan"]; ?></p>

                    <ul class="list-unstyled">
                        <li>
                            <a href="mailto:<?php echo $ambil_data[0]["email"]; ?>" title="" class="link-like-text">email -></a>
                        </li>
                        <li>
                            <a href="<?php echo $ambil_data[0]["instagram"]; ?>" title="" class="link-like-text">instagram -></a>
                        </li>
                        <li>
                            <a href="<?php echo $ambil_data[0]["github"]; ?>" title="" class="link-like-text">github -></a>
                        </li>
                    </ul>
                </div>
            </div>
